...
var TKPropertyEditorParamsDirective = (function () {
    ...
    TKPropertyEditorParamsDirective.decorators = [
        { type: core_1.Directive, args: [{
                    selector: "TKPropertyEditorParams"
                },] },
    ];
    /** @nocollapse */
    TKPropertyEditorParamsDirective.ctorParameters = function () { return [
        { type: core_1.ElementRef, decorators: [{ type: core_1.Inject, args: [core_1.ElementRef,] },] },
    ]; };
    return TKPropertyEditorParamsDirective;
}());
exports.TKPropertyEditorParamsDirective = TKPropertyEditorParamsDirective;
var TKEditorParamsDirective = (function () {
    ...
    TKEditorParamsDirective.decorators = [
        { type: core_1.Directive, args: [{
                    selector: "[tKEditorParams]"
                },] },
    ];
    /** @nocollapse */
    TKEditorParamsDirective.ctorParameters = function () { return [
...
element_registry_1.registerElement("TKPropertyEditorParams", function () { return _1.PropertyEditorParams; });
